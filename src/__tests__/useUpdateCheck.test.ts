...
function mockRelease(tag: string, url = 'https://github.com/varkart/contextbar/releases/tag/' + tag) {
...
describe('useUpdateCheck', () => {
  ...
  it('uses cache and skips second fetch within TTL', async () => {
    ...
    await waitFor(() => {
      expect(localStorage.getItem('contextbar:updateCheck')).not.toBeNull()
    })
    unmount()

...
const tool: AiTool = {
  ...
  skills: [
    ...
    { name: 'graphify',   path: '~/.claude/skills/graphify',   description: 'Graphs',    active: true,  sourceId: 'skills_dir' },
    { name: 'xlsx',       path: '~/.claude/skills/.disabled/xlsx', description: 'Excel', active: false, sourceId: 'skills_dir' },
    { name: 'alpha', path: '/a', description: undefined, active: true, sourceId: 'skills_dir' },
    { name: 'beta',  path: '/b', description: undefined, active: true, sourceId: 'skills_dir' },
    { name: 'gamma', path: '/c', description: undefined, active: true, sourceId: 'skills_dir' },
  ],
  mcps: [],
  error: undefined,
}
...
describe('SkillsListPanel', () => {
  it('renders tool name breadcrumb', () => {
    render(<SkillsListPanel tool={tool} onBack={vi.fn()} onSelectSkill={vi.fn()} />)
  ...
  it('back button calls onBack', () => {
    const onBack = vi.fn()
    render(<SkillsListPanel tool={tool} onBack={onBack} onSelectSkill={vi.fn()} />)
  ...
  it('clicking skill calls onSelectSkill', () => {
    ...
    render(<SkillsListPanel tool={tool} onBack={vi.fn()} onSelectSkill={onSelectSkill} />)
  ...
  it('hides search input when 5 or fewer skills', () => {
    ...
    render(<SkillsListPanel tool={smallTool} onBack={vi.fn()} onSelectSkill={vi.fn()} />)

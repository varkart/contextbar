...
function makeTool(id: string, name: string, skills: Skill[], installed = true): AiTool {
  return {
    id,
    name,
    installed,
...
describe('AllSkillsView — renders skills', () => {
  it('renders all unique skill names from installed tools', () => {
    render(<AllSkillsView tools={[singleTool]} onBack={vi.fn()} onSelectSkill={vi.fn()} />)
  ...
  it('does not render skills from uninstalled tools', () => {
    ...
    render(<AllSkillsView tools={[singleTool, notInstalled]} onBack={vi.fn()} onSelectSkill={vi.fn()} />)
  ...
  it('deduplicates skills with the same name across tools', () => {
    ...
    render(<AllSkillsView tools={[claudeTool, cursorTool]} onBack={vi.fn()} onSelectSkill={vi.fn()} />)
...
describe('AllSkillsView — interaction', () => {
  it('clicking a skill calls onSelectSkill with the primary skill', () => {
    ...
    render(<AllSkillsView tools={[singleTool]} onBack={vi.fn()} onSelectSkill={onSelectSkill} />)

...
export default function AllSkillsView({ tools, onBack, onSelectSkill }: Props) {
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--c-bg)]">
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 border-b border-[var(--c-border)] flex-shrink-0">
        ...
        <span className="text-[15px] font-semibold text-[var(--c-text)] tracking-[-0.01em] flex-1">Skills</span>

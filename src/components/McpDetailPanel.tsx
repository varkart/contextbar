...
export default function McpDetailPanel({ mcp, onBack, toolName, toolId, onToggled, allTools }: McpDetailPanelProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--c-bg)] animate-slide-in-right">
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 border-b border-[var(--c-border)] flex-shrink-0">
        ...
        <span className="text-[15px] font-semibold text-[var(--c-text)] tracking-[-0.01em] truncate flex-1">
          MCPs
        </span>
        <span className="text-[12px] bg-violet-500/10 text-violet-400 px-1.5 py-0.5 rounded font-mono flex-shrink-0">MCP</span>
      </div>

    ...
    <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-2 items-end">
      {toasts.map(t => (
        <div
          key={t.id}
          role="status"
          className="flex items-center gap-2.5 min-w-[240px] max-w-sm bg-[var(--c-surface)] border border-[var(--c-border)] rounded-lg px-3.5 py-2.5 text-[13px] shadow-xl animate-toast-in"
        >
